...
class User():
    ...
    def get_my_follow_user(self, request):
        if "uid" not in request.session:
            ...
            return response
        user_id = request.session.get("uid")
        query_str = "select ?x ?z where{ ?y <file:///D:/d2rq-0.8.1/vocab/userrelation_suid> \"" + user_id + "\"."
        query_str += "?y <file:///D:/d2rq-0.8.1/vocab/userrelation_tuid> ?x."
        query_str += "?v <file:///D:/d2rq-0.8.1/vocab/user_uid> ?x."
        query_str += "?v <file:///D:/d2rq-0.8.1/vocab/user_screen_name> ?z.}"
        res = self.gstore.query("weibo", query_str)
        res = res["results"]["bindings"]
        users = []
        for i in res:
    ...
    def get_follow_user(self, request, uid):
        if "uid" not in request.session:
            ...
            return response
        user_id = request.session.get("uid")
        query_str = "select ?x ?z where{ ?y <file:///D:/d2rq-0.8.1/vocab/userrelation_suid> \"" + uid + "\"."
        query_str += "?y <file:///D:/d2rq-0.8.1/vocab/userrelation_tuid> ?x."
        query_str += "?v <file:///D:/d2rq-0.8.1/vocab/user_uid> ?x."
        query_str += "?v <file:///D:/d2rq-0.8.1/vocab/user_screen_name> ?z.}"
        res = self.gstore.query("weibo", query_str)
        ...
        for i in res:
            ...
            users.append(user)
        context = {'follow_users': users, 'uid': uid}
    ...
    def get_my_fan(self, request):
        if "uid" not in request.session:
            ...
            return response
        user_id = request.session.get("uid")
        query_str = "select ?x ?z where{ ?y <file:///D:/d2rq-0.8.1/vocab/userrelation_tuid> \"" + user_id + "\"."
        query_str += "?y <file:///D:/d2rq-0.8.1/vocab/userrelation_suid> ?x."
        query_str += "?v <file:///D:/d2rq-0.8.1/vocab/user_uid> ?x."
        query_str += "?v <file:///D:/d2rq-0.8.1/vocab/user_screen_name> ?z.}"
        res = self.gstore.query("weibo", query_str)
        res = res["results"]["bindings"]
    ...
    def get_fan(self, request, uid):
        if "uid" not in request.session:
            ...
            return response
        user_id = request.session.get("uid")
        query_str = "select ?x ?z where{ ?y <file:///D:/d2rq-0.8.1/vocab/userrelation_tuid> \"" + uid + "\"."
        query_str += "?y <file:///D:/d2rq-0.8.1/vocab/userrelation_suid> ?x."
        query_str += "?v <file:///D:/d2rq-0.8.1/vocab/user_uid> ?x."
        query_str += "?v <file:///D:/d2rq-0.8.1/vocab/user_screen_name> ?z.}"
        res = self.gstore.query("weibo", query_str)
